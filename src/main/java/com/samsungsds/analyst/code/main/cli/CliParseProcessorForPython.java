...
public class CliParseProcessorForPython extends AbstractCliParseProcessor {
    ...
    public void setDefaultIndividualModeAfterParsing(CliParsedValueObject parsedValue) {
        parsedValue.getIndividualMode().setLanguageType(Language.PYTHON);

        // keep values : CodeSize, Duplication, Complexity + SonarPython
    ...
    public String getModeErrorMessage() {
        return "'mode' option can only have 'code-size', 'duplication', 'complexity' and 'sonarpython' (with or without '-')";
    }
}
