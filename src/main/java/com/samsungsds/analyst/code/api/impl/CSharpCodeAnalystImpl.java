...
public class CSharpCodeAnalystImpl extends GeneralLanguageCodeAnalystImpl {
	private static final Logger LOGGER = LogManager.getLogger(CSharpCodeAnalystImpl.class);
