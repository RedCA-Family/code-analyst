...
public class ComplexityAnalysisESLintLauncher implements ComplexityAnalysis {
    ...
    public void run(String instanceKey) {
        ...
        try {
            ...
            File srcDirectory = new File(options.get("-dir"));
            subParameters.add(srcDirectory.getCanonicalPath());
        ...
        for (ESLintResultFile result : results) {
            ...
            for (ESLintResultMessages message : result.getMessages()) {
                if ("complexity".equals(message.getRuleId())) {
                    ...
                    Pattern p = Pattern.compile("^(Function|Method|Generator function|Static method|Arrow function) '(.+)' has a complexity of ([0-9]+)\\.$");
                    ...
                    if (m.find()) {
                        ...
                        Pattern p2 = Pattern.compile("^(Function|Method|Generator function|Static method|Arrow function) has a complexity of ([0-9]+)\\.$");
